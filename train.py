...
def get_args(**kwargs):
    ...
    # Check if argument for classes and training labels is correctly named
    parser.add_argument('--classes', type=int, default=26, help='dataset classes')
    parser.add_argument('--train_label_path', dest='train_label', type=str, default='train.txt', help="train label path")
    parser.add_argument('--optimizer', type=str, default='adam',
                        help='training optimizer', dest='TRAIN_OPTIMIZER')
    parser.add_argument('--iou-type', type=str, default='iou', help='iou type', dest='iou_type')
    parser.add_argument('--keep-checkpoint-max', type=int, default=10,
                        help='maximum number of checkpoints to keep', dest='keep_checkpoint_max')
